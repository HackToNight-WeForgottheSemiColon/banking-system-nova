...
function AccountsPageContent() {
  ...
  // Fetch accounts on mount and screen transitions
  ...
  // Load data based on URL query parameters
  useEffect(() => {
    if (isEditMode) {
      setFormData({
        ...
        {screen === 'list' && (
          <>
            ...
            <div className={styles.cardsContainer}>
              {loading ? (
                <div className={styles.loadingMsg}>Loading accounts...</div>
              ) : accounts.length > 0 ? (
                accounts.map((acc) => (
                  <div className={styles.accountCard} key={acc.id}>
                    <div
                      ...
                      onClick={() => {
                        router.push(
                          `/bank-accounts?mode=edit&accountNumber=${acc.accountNumber}&accountName=${acc.accountName}&nickname=${acc.accountName}`
                        )
                      }}
                    ...
                    <div className={styles.accountCardContent}>
                      <h2 className={styles.accountName}>{acc.accountName}</h2>
                ...
                >
                  <div className={styles.formGroup}>
                    ...
                    <input
                      type="text"
                      id="accountNumber"
                      value={formData.accountNumber || accountNumberParam}
                      disabled
